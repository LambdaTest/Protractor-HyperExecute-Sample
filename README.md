...
[<img alt="Run in Gitpod" width="200 px" align="center" src="images/Gitpod.svg" />](https://hyperexecute.lambdatest.com/hyperexecute/jobs?type=gitpod&framework=Protractor)
---
...
# How to run Selenium automation tests on HyperExecute (using protractor framework) — TestMu AI (Formerly LambdaTest)
